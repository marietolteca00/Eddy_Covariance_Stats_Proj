...
"B2 = `r round(B2, 2)` (β₂): For each 1°F increase in mean air temperature, expected 
ETo is multiplied by exp(β₂) = `0.046`. This corresponds to approximately a `4.6%` increase in ETo, holding precipitation constant."
